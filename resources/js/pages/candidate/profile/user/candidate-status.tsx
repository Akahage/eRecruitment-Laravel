...
import AdministrationOngoing from './administration-ongoing';
import AdministrationPassed from './administration-passed';
import AssesmentPending from './assesment-pending'
...
export default CandidateStatus;1